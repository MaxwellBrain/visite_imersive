...
présenté au tableau~\ref{tab:chronogramme}, reporté en annexe~7.
...
principes exposés au chapitre~1, la dépense a été estimée au moyen d'\emph{Infracost},
un outil qui lit les fichiers de description de l'infrastructure et en déduit le
coût mensuel avant même que les ressources ne soient créées. Ce choix n'est pas
indifférent : un relevé de facturation constate une dépense déjà engagée, tandis
qu'\emph{Infracost} la fait apparaître au moment de la modification du code, donc
au moment où l'on peut encore y renoncer. Le tableau~\ref{tab:finops} détaille la
dépense par service.
